...
//     }
document.getElementById("button").onclick = function(){
    if (document.getElementById("uname").value == "" || document.getElementById("department").value == "" || document.getElementById("batch").value == ""){
       window.alert("you need to insert your information");
   } 
